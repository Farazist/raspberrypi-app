...
Rectangle {
    ...
    Flickable {
        id: flickableAdmin
        anchors.fill: parent
        contentWidth: contentAdmin.width
        contentHeight: contentAdmin.height
        ...
        MouseArea  {
            id: contentAdmin
            width: flickableAdmin.width
            height: textEditorsAdmin.height + 24
            ...
            Column {
                ...
                Button {
                    ...
                    font.pixelSize: 24
                    onClicked: {
                        buttonClickedAdmin.text = "clicked"
                    }
                }
                Label {
                    id: buttonClickedAdmin
                    color: "#ff0000"
                    anchors.horizontalCenter: parent.horizontalCenter
                    font.pixelSize: 22
                }
    ...
    InputPanel {
        ...
        states: State {
            name: "visible"
            when: inputPanelAdmin.active
            PropertyChanges {
                target: inputPanelAdmin
                y: parent.height - inputPanelAdmin.height - 120
            }
        }
